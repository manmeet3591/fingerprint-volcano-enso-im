...
#HADCM3
data = np.genfromtxt('pr_Amon_IPSL-CM5A-LR_piControl_r1i1p1_180001-279912_goswami_india_tseries.csv', delimiter = ',').flatten()
#GISS
...
np.savetxt('pr_ipsl_pi'+str(i)+'.csv', surr, delimiter=",")
