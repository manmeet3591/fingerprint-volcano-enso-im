...
#HADCM3
data = np.genfromtxt('nino3_1871_2016.csv', delimiter = ',').flatten()
#GISS
...
#HADCM3
surr = recurrence_v1.surrogates(data, ns=1, method='twins', m=35, tau=5, e=0.2, norm='euclidean', threshold_by='frr' , verbose=False)
#GISS
#surr = recurrence_v1.surrogates(data, ns=1, method='twins', m=50, tau=6, e=0.2, norm='euclidean', threshold_by='frr' , verbose=False)

np.savetxt('nino3_'+str(i)+'.csv', surr, delimiter=",")
