...
def surrogates(x, ns, method, m, tau, e, norm, threshold_by , verbose=False):
    """
    ...
    if method == "iaaft":               # iAAFT
        ...
        R = rp(x, m, tau, e, norm, threshold_by)
        ...
        # 2. Identify twins
        utils._printmsg("identify twins ...", verbose)
        is_twin = []
        twins = []
        ...
        utils._printmsg("generate surrogates ...", verbose)
        all_idx = range(ne)
