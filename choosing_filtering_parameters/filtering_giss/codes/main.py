...
def load_data():
    ...
    # load the data
    DATPATH = "../data/"
    fnino = DATPATH + "tos_Omon_GISS-E2-R_past1000_r1i1p128_0850_1850_nino3_tseries.csv"
    dnino = np.genfromtxt(fnino, delimiter=",", dtype=float).flatten()-273.15
    fismr = DATPATH + "pr_Amon_GISS-E2-R_past1000_r1i1p128_0850_1850_goswami_india_tseries.csv"
...
def plot(time, nino_dat, ismr_dat, c, N):
    ...
    xlo, xhi = dt.datetime(1871, 1, 1), dt.datetime(2003, 12, 31)
    for ax in [ax1, ax2]:
        ax.set_xlim(xlo, xhi)
