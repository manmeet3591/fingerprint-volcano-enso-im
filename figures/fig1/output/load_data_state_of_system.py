...
w_ens2  = nc.Dataset(dir_+'sst_ocean_2004_2006_anom_nino3_fldmean.nc')
w_ens3  = nc.Dataset(dir_+'sst_ocean_2017_2019_anom_nino3_fldmean.nc')
w_ens4  = nc.Dataset(dir_+'sst_ocean_2079_2081_anom_nino3_fldmean.nc')
w_ens5  = nc.Dataset(dir_+'sst_ocean_2142_2144_anom_nino3_fldmean.nc')
w_ens6  = nc.Dataset(dir_+'sst_ocean_2145_2147_anom_nino3_fldmean.nc')
#w_ens7  = nc.Dataset(dir_+'sst_ocean_2219_2221_anom_nino3_fldmean.nc')
w_ens8  = nc.Dataset(dir_+'sst_ocean_2256_2258_anom_nino3_fldmean.nc')
w_ens9  = nc.Dataset(dir_+'sst_ocean_2261_2263_anom_nino3_fldmean.nc')
w_ens10 = nc.Dataset(dir_+'sst_ocean_2293_2295_anom_nino3_fldmean.nc')
w_ens11 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1971.nc')
w_ens12 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1999.nc')
w_ens13 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2005.nc')
w_ens14 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2010.nc')
w_ens15 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2031.nc')
w_ens16 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2032.nc')
w_ens17 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2034.nc')
w_ens18 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2059.nc')
w_ens19 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2067.nc')
w_ens20 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2094.nc')
w_ens21 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2097.nc')
w_ens22 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2100.nc')
w_ens23 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2115.nc')
w_ens24 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2131.nc')
w_ens25 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2135.nc')
w_ens26 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2146.nc')
w_ens27 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2150.nc')
w_ens28 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2166.nc')
#w_ens29 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2167.nc')
w_ens30 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2176.nc')
w_ens31 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2216.nc')
w_ens32 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2217.nc')
w_ens33 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2227.nc')
w_ens34 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2228.nc')
w_ens35 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2231.nc')
w_ens36 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2242.nc')
#w_ens37 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2247.nc')
w_ens38 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1959.nc')
w_ens39 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1974.nc')
w_ens40 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1991.nc')
w_ens41 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2040.nc')
w_ens42 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2050.nc')
w_ens43 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2063.nc')
w_ens44 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2077.nc')
w_ens45 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2105.nc')
w_ens46 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2129.nc')
w_ens47 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2164.nc')
w_ens48 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2172.nc')
#w_ens49 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2189.nc')
w_ens50 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2201.nc')
w_ens51 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2239.nc')
w_ens52 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2240.nc')
#w_ens53 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2250.nc')
w_ens54 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2267.nc')
w_ens55 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2286.nc')

dir_ = "/iitm2/cccr-res/msingh/pmip_data_scripts/agu_volcano/state_of_system/data/cold_phase/"
c_ens1 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1958.nc')
c_ens2 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1969.nc')
c_ens3 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1988.nc')
c_ens4 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1997.nc')
c_ens5 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2001.nc')
c_ens6 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2015.nc')
c_ens7 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2023.nc')
c_ens8 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2055.nc')
c_ens9 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2112.nc')
c_ens10 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2117.nc')
c_ens11 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2122.nc')
c_ens12 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2125.nc')
c_ens13 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2133.nc')
c_ens14 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2140.nc')
c_ens15 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2148.nc')
c_ens16 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2152.nc')
c_ens17 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2156.nc')
c_ens18 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2159.nc')
c_ens19 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2170.nc')
c_ens20 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2171.nc')
c_ens21 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2214.nc')
c_ens22 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2244.nc')
c_ens23 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2253.nc')
c_ens24 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1964.nc')
c_ens25 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1977.nc')
c_ens26 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1982.nc')
c_ens27 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_1995.nc')
c_ens28 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2013.nc')
c_ens29 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2021.nc')
c_ens30 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2025.nc')
c_ens31 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2026.nc')
c_ens32 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2042.nc')
c_ens33 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2080.nc')
c_ens34 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2110.nc')
c_ens35 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2136.nc')
c_ens36 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2193.nc')
c_ens37 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2198.nc')
c_ens38 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2211.nc')
c_ens39 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2218.nc')
c_ens40 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2220.nc')
c_ens41 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2224.nc')
c_ens42 = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_2246.nc')
c_ens43 = nc.Dataset(dir_+'sst_ocean_1968_1970_anom_nino3_fldmean.nc')
c_ens44 = nc.Dataset(dir_+'sst_ocean_1979_1981_anom_nino3_fldmean.nc')
c_ens45 = nc.Dataset(dir_+'sst_ocean_2051_2053_anom_nino3_fldmean.nc')
c_ens46 = nc.Dataset(dir_+'sst_ocean_2061_2063_anom_nino3_fldmean.nc')
c_ens47 = nc.Dataset(dir_+'sst_ocean_2062_2064_anom_nino3_fldmean.nc')
c_ens48 = nc.Dataset(dir_+'sst_ocean_2073_2075_anom_nino3_fldmean.nc')
c_ens49 = nc.Dataset(dir_+'sst_ocean_2104_2106_anom_nino3_fldmean.nc')
c_ens50 = nc.Dataset(dir_+'sst_ocean_2128_2130_anom_nino3_fldmean.nc')
...
w_ens26_4x = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_ocean_2146.nc')
...
w_ens33_025x = nc.Dataset(dir_+'fldmean_nino3_anom_mon_sst_ocean_2227.nc')
